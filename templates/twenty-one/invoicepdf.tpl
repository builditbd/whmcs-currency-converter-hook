...
if($clientsdetails['currency'] == "1") {
    ...
    $invoicetotal = Capsule::table('tblinvoices')
        ->where('id', $invoiceid)
        ->value('total');

    $convertedAmountRow = '
    <tr height="30" bgcolor="#efefef" style="font-weight:bold;">
        <td align="right">Amount in BDT (1 USD = '.$exchangerate.' BDT)</td>
        <td align="center">'.$invoicetotal*$exchangerate.' BDT</td>
    </tr>';
}
$tblhtml .= '
    <tr height="30" bgcolor="#efefef" style="font-weight:bold;">
